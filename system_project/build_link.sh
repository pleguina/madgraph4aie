#!/bin/bash
# ============================================================================
# System Link Script for 80-Pipeline Architecture
# Links AIE graph + PL kernels → creates hardware binary
# ============================================================================
...
# ============================================================================
echo "=========================================="
echo " System Linking: 80-Pipeline Architecture"
echo "=========================================="
...
# ============================================================================
echo "=========================================="
echo " Starting v++ Link (this may take 1-2 hours)"
echo "=========================================="
echo ""
...
v++ -l \
    ...
    --connectivity.sp s2mm_8.result_buffer:DDR \
    --connectivity.sp s2mm_9.result_buffer:DDR \
    -o ${OUTPUT_NAME}.xsa \
    ${MM2S_XO} \
    ${S2MM_XO} \
    ${AIE_LIBADF}
...
if [ $LINK_STATUS -eq 0 ] && [ -f "${BUILD_DIR}/${OUTPUT_NAME}.xsa" ]; then
    ...
    echo ""
    echo "Next steps:"
    echo "  1. Check timing reports in reports/"
    echo "  2. Build host application (run build_host.sh)"
    echo "  3. Package SD card (run package_sd.sh)"
elif [ $LINK_STATUS -ne 0 ]; then
    echo " ✗ System Link FAILED (Exit Code: $LINK_STATUS)"
    echo "=========================================="
    echo ""
    ...
    echo " ✗ System Link FAILED (Output file not generated)"
    echo "=========================================="
    echo ""
    echo "v++ completed but did not generate output file:"
    echo "  Expected: ${BUILD_DIR}/${OUTPUT_NAME}.xsa"
    echo ""
    echo "Check logs for errors:"
    echo "  tail -100 ${BUILD_DIR}/logs/link.log"
    echo ""
...
# ============================================================================
if [ -f "${BUILD_DIR}/reports/link.summary" ]; then
    echo ""
    echo "=========================================="
    echo " Resource Utilization Summary"
    echo "=========================================="
    cat "${BUILD_DIR}/reports/link.summary" | head -50
fi
